...
### WebAssembly / WASM
Graph1 is not a [WebAssembly](https://webassembly.org/)-specific library. You can compile your Graph1 application to WebAssembly (like the demos on this site) though. For WebAssembly-first development I could recommend [AssemblyScript](https://www.assemblyscript.org/), especially if you are a web developer.
